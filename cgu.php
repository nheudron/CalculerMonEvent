...
<title>Calculer mon Evenement</title>
	...
	<main>
		<form id="formUser" style="formColumn" method="post" action="formProcess.php">
			<label for="entreprise">Société *</label><br><input type="text" name="company" id="entreprise" required class="incorrect"><br>
			<label for="email">email *</label><br><input type="email" name="email" id="email" required class="incorrect"><br>
